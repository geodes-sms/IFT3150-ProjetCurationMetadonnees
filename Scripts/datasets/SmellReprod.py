"""
SmellReprod Systematic Literature Review Dataset Processing Script

Processes the SmellReprod systematic review dataset on "How far are we from 
reproducible research on code smell detection?" for metadata curation and 
standardization.

Author: Guillaume Genois, 20248507
Dataset: SmellReprod (Reproducible Research on Code Smell Detection)
Paper: https://www.sciencedirect.com/science/article/pii/S095058492100224X
"""
...
# Exclusion criteria descriptions for the SmellReprod systematic review
...
class SmellReprod(SRProject):
    """
    SmellReprod Systematic Literature Review Dataset Handler.
    
    Processes the systematic review dataset on reproducible research in code smell 
    detection. This dataset contains 1736 articles with 169 included and 1567 
    excluded (10% inclusion rate).
    
    Dataset characteristics:
    - Size: 1736 articles
    - Included: 169 articles
    - Excluded: 1567 articles
    - Inclusion rate: 10%
    - Has conflict data: No
    - Criteria labeled: Yes
    - Has abstract text: No
    
    Processing notes: Full-text decision available
    """

    def __init__(self):
        """
        Initialize the SmellReprod dataset processor.
        
        Loads data from Excel sheet with detailed inclusion/exclusion criteria.
        """
        super().__init__()
...
if __name__ == '__main__':
    try:
        ...
        print(f"Error processing SmellReprod dataset: {e}")
